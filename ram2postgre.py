...
class RamDdl:
    ...
    def _create_fields(self, table):
        ...
        for field in table:
            ...
            if field.domain.unnamed:
                type = type_[field.domain.type.upper()]     # Конвертируем исходный тип в тип PostgreSql поиском в списке по кдючу
    ...
    def _create_constraints(self):                          # Создание ограничений
        for table in self.schema.tables:
            pkeys = ""
            pk_count = 0
